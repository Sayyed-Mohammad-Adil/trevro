    ...
    user.save(function (err, savedUser) {
      ...
      email
        ...
        .then(function (html) {
          const mailOptions = {
            to: savedUser.email,
            subject: '[Trevyro] Account Recovery',
            html: html,
    ...
    user.save(function (err, savedUser) {
      ...
      async.waterfall(
        ...
        function (err, template) {
          ...
          let subject = '[Trevyro] Password Reset Request'
      ...
      user.save(function (err, updated) {
        ...
        email
          ...
          .then(function (html) {
            const mailOptions = {
              to: updated.email,
              subject: '[Trevyro] Two-Factor Authentication Removed!',
              html: html,
              generateTextFromHTML: true
            }
