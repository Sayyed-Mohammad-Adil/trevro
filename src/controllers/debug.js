...
debugController.populatedatabase = function (req, res) {
  ...
  const subjects = [
    ...
    'Incorrect Time Showing in trevyro',
    ...
    'UPS problem at Unity System/Password problem with Trevyro',
...
debugController.sendmail = function (req, res) {
  ...
  email
    ...
    .then(function (html) {
      const mailOptions = {
        to: to,
        subject: 'Trevyro Test Email #' + ticket.uid + ' [Debugger]',
        html: html,
