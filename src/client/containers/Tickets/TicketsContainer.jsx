 ...
 *  Copyright (c) 2014-2019 Trevyro, Inc. All rights reserved.
 */
...
class TicketsContainer extends React.Component {
  ...
  componentDidMount () {
    this.props.socket.on('$trevyro:client:ticket:created', this.onTicketCreated)
    this.props.socket.on('$trevyro:client:ticket:updated', this.onTicketUpdated)
    this.props.socket.on('$trevyro:client:ticket:deleted', this.onTicketDeleted)
  ...
  componentWillUnmount () {
    ...
    this.props.socket.off('$trevyro:client:ticket:created', this.onTicketCreated)
    this.props.socket.off('$trevyro:client:ticket:updated', this.onTicketUpdated)
    this.props.socket.off('$trevyro:client:ticket:deleted', this.onTicketDeleted)
  }
