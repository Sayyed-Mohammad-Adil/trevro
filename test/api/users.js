...
describe('api/users.js', function () {
  ...
  it('should return users', function (done) {
    request
      .get('/api/v1/users?limit=10&page=0&search=trevyro')
  ...
  it('should return a user', function (done) {
    request
      .get('/api/v1/users/trevyro')
      .set('accesstoken', tdapikey)
      .set('Accept', 'application/json')
      .expect(function (res) {
        if (res.body.user.username !== 'trevyro') throw new Error('Invalid User')
      })
      .expect(200, done)
  })
  ...
  it('should add user to group', function (done) {
    ...
    groupSchema.getGroupByName('TEST', function (err, group) {
      ...
      userSchema.getUserByUsername('trevyro', function (err, user) {
        expect(err).to.not.exist
        var u = {
  ...
  it('should update user preference', function (done) {
    ...
    request
      .put('/api/v1/users/trevyro/updatepreferences')
      .set('accesstoken', tdapikey)
      .set('Content-Type', 'application/json')
      .send(data)
      .set('Accept', 'application/json')
  ...
  //         .set('accesstoken', tdapikey)
  //         .set('Content-Type', 'application/json')
  //         .send({user: {email: 'public.user@trevyro.io', password: 'password', fullname: 'public.user@trevyro.io'}})
  //         .expect(function(res) {
  //             console.log(res);
